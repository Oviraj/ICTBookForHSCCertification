...
public class VideoTwoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_video_two,
                container, false);
        ...
        String uriPath2 = "android.resource://ictbook.ingenium.ictbookforhsccertification/"+R.raw.cprogram;
        ...
        buttonPlayVideo2.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                VideoView mVideoView2 = (VideoView) view.findViewById(R.id.videoView);
                String uriPath = "android.resource://ictbook.ingenium.ictbookforhsccertification/" + R.raw.cprogram;
